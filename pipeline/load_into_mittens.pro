PRO load_into_mittens, desired_lspm, remake=remake, all=all, old=old
;+
; NAME:
;	load_into_mittens
; PURPOSE:
...
; RESTRICTIONS:
; EXAMPLES:
;	load_into_mittens, /all	; (load all FITS light curves, from all seasons and telescopes, into @MITTENS_DATA)
;	load_into_mittens, 1186 ; (loads a specific star, identified by LSPM number)
;
...
;-
	...
	common mearth_tools
	mprint, 'LOAD_INTO_MITTENS.PRO is loading light curve(s) into ' + working_dir
