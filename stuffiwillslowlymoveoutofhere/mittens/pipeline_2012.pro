PRO pipeline_2012, lspm, old=old, remake=remake, year=year, fake=fake, nofold=nofold, bulldoze=bulldoze, trimtransits=trimtransits
;+
; NAME:
;	pipeline_2012
; PURPOSE:
...
; 	if keyword_set(lspm) then i = get_lspm_info(lspm)
	...
	; by default, just look at stars from within this year
	...
	for i=0, n_elements(f)-1 do begin
		...
		if file_test(star_dir() + 'raw_target_lc.idl') eq 0 then continue
