PRO lcogt_whitepaper, eps=eps, remake=remake
...
;	gj1214b_pop = simulate_a_population(supersampled, /gj1214b)
 ...
 ;	francois_hwm = statpaper_howmanyplanets( supersampled, francois_pop, label='statpaper_fressin_', period_scale=francois_period_scale, temperature_scale=francois_temperature_scale)
 	courtney_hwm = statpaper_howmanyplanets( supersampled, coolkoi_smooth_pop, label='statpaper_dressing_', period_scale=coolkoi_period_scale, temperature_scale=coolkoi_temperature_scale)
...
;	courtney_hwm = statpaper_howmanyplanets( supersampled, coolkoi_pop, label='statpaper_1actual_dressing_',  eps=eps, period_scale=max_period_scale, temperature_scale=max_temperature_scale);, period_scale=max_period_scale, temperature_scale=max_temperature_scale)
	courtney_smooth_hwm = lcogt_howmanyplanets( supersampled, coolkoi_smooth_pop, label='statpaper_1actual_dressing_smooth_',  eps=eps, period_scale=max_period_scale, temperature_scale=max_temperature_scale)
...
;	courtney_hwm = statpaper_howmanyplanets( supersampled, coolkoi_pop, label='statpaper_2triggered_dressing_',  eps=eps);, period_scale=max_period_scale, temperature_scale=max_temperature_scale)
	courtney_smooth_hwm = lcogt_howmanyplanets( supersampled, coolkoi_smooth_pop, label='statpaper_2triggered_dressing_smooth_',  eps=eps, period_scale=max_period_scale, temperature_scale=max_temperature_scale)

	period_expectation = coolkoi_smooth_pop.period*supersampled.period_sensitivity*supersampled.dlogperiod_grid*supersampled.dlogradius_grid
	temperature_expectation = coolkoi_smooth_pop.temperature*supersampled.temperature_sensitivity*supersampled.dlogtemperature_grid*supersampled.dlogradius_grid
	save, period_expectation,temperature_expectation, coolkoi_smooth_pop, supersampled, filename='lcogt_expectation.idl'
