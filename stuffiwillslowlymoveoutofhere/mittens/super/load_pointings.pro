FUNCTION load_pointings, year=year, tel=tel, lspm=lspm, radius_range=radius_range, n=n
...
;	skip_list = [	'ls3229/ye10/te04/', 'ls3229/ye10/te07/', 'ls1186/ye10/te01/'];, $
	...
	te = long(stregex(/ext, stregex(/ext, f, 'te[0-9]+'), '[0-9]+'))
 	n = n_elements(f)
	s = create_struct('LS', 0, 'YE', 0, 'TE', 0, 'MJD', 0.0d, 'EXPTIME', 0.0,  'NEXP', 0, 'OVERTIME', 0.0,'AST', 0B)
	for i=0, n-1 do begin
		star_dir = f[i]
		print, star_dir
		restore, star_dir + 'ext_var.idl', /rel
