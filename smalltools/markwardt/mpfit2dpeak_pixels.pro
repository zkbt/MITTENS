...
forward_function mpfit, mpfitfun, mpfit2dpeak_pixels, mpfit2dpeak_gauss_pixels, $
...
; Gaussian Function
function mpfit2dpeak_gauss_pixels, x, y, p, tilt=tilt, symmetric=sym, _extra=extra
  COMPILE_OPT strictarr
;   sz = size(x)
...
function mpfit2dpeak_pixels, z, a, x, y, estimates=est, tilt=tilt, $
